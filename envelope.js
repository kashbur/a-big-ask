...
.note-continue{
  ...
  padding:.85rem 2.2rem; border-radius:999px; border:1.5px solid #1f1f1f;
  background: var(--paper, #f2e6d0); color:#fff; font:600 16px "Courier New", monospace;
  letter-spacing:.02em; text-shadow:0 0 4px rgba(0,0,0,.35);
